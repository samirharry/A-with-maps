...
<html lang="es">
  ...
  <body style="background: rgba(255, 240, 201)">
    <h1 style="text-align: center;" >
        USO DEL ALGORITMO A* PARA  
    </h1>
    <h1 style="text-align: center;" >
        EL CÁLCULO DE LA RUTA MÁS CORTA EN UN MAPA
    </h1>
    <div class="row">
        <div class="col-lg-2"></div>
        <div class="col-lg-6">
            <canvas id="lienzoprincipal" width="708" height="485" style="background-image: url('mapa4.png');border-style:double ;border-width:2px;" ></canvas> 
